    ...
    <div className="container mx-auto px-2 md:px-4 py-10">
      <div className="grid md:grid-cols-12 gap-10">
        <div className="hidden md:block md:col-span-4 lg:col-span-3 shadow-lg h-fit sticky top-10 bg-[#eff0f2] text-black rounded-lg px-6 py-4">
          <div className="w-28 h-28 md:w-[143px] md:h-[143px] mx-auto mb-5 rounded-ful overflow-hidden">
            <Image
              src={userData.image}
              alt={userData.name}
              width={143}
          ...
          <div className="font-normal text-left">
            <h6 className="text-lg font-bold">{userData.name}</h6>
          </div>
        ...
        <div className="md:col-span-8 lg:col-span-9">
          ...
          <nav className="sticky top-0 px-2 w-fit mx-auto md:w-full md:px-5 py-3 mb-8 text-gray-700 border-gray-200 rounded-lg bg-gray-50 mt-7">
            <ol
              className={`${
